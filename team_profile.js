...
function formCallback(data){
	if (data.admin){
		var displays = {
			...
			"High_Goal_Auton": data.Match_Data.High_Goal_Auton || 0,
			"Low_Goal_Auton": data.Match_Data.Low_Goal_Auton || 0,
			...
			"Gear_Attempts_Teleop": data.Match_Data.Gear_Attempts_Teleop,
