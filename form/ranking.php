<?php
	...
	function ranking($team){
		...
		$result["Pg"] = ($team["Gear_Placed_Auton"] + $team["Gear_Placed_Teleop"]/ $team["Total_Game_Points"]);
		if ($team["Total_Game_Points"]) $result["Pl"] = (($team["Low_Goal_Auton"] + $team["Low_Goal_Teleop"]) / 9) / $team["Total_Game_Points"];
			else $result["Pl"] = null;
		foreach($result as $key=>$value){
			$result[$key] = round($value * 1000000) / 1000000;
		}
		return $result;
	}
